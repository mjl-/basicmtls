...
dial: build
	./basicmtls dial localhost:1234 client1.privkey server1.pubkey
...
dial21: build
	./basicmtls dial localhost:1234 client2.privkey server1.pubkey

dial22: build
	./basicmtls dial localhost:1234 client2.privkey server2.pubkey
...
openssl:
	openssl s_client -connect localhost:1234 -no_check_time
